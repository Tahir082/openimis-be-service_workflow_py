...
from service_workflow.models import FormSection

logger = logging.getLogger(__name__)


class FormSectionServices(BaseService):
    OBJECT_TYPE = FormSection
    ...
    def delete(self, obj_data):
        obj_data["user_updated"] = self.user
        FormSection.objects.get(id=obj_data["id"]).delete(username=self.user.username)
