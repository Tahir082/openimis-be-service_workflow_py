...
from service_workflow.models import WorkflowStep

logger = logging.getLogger(__name__)


class WorkflowStepServices(BaseService):
    ...
    def delete(self, obj_data):
        obj_data["user_updated"] = self.user
        WorkflowStep.objects.get(id=obj_data["id"]).delete(username=self.user.username)
