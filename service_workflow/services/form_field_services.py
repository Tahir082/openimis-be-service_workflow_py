...
from service_workflow.models import FormField

logger = logging.getLogger(__name__)


class FormFieldServices(BaseService):
    OBJECT_TYPE = FormField
    ...
    def delete(self, obj_data):
        obj_data["user_updated"] = self.user
        FormField.objects.get(id=obj_data["id"]).delete(username=self.user.username)
