...
class WorkflowStepApprovalServices(BaseService):
    OBJECT_TYPE = WorkflowStepApproval
    ...
    def delete(self, obj_data):
        obj_data["user_updated"] = self.user
        WorkflowStepApproval.objects.get(id=obj_data["id"]).delete(username=self.user.username)
